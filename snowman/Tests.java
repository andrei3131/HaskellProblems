public class Tests {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(PieceUtils.charToPiece('/'));
    System.out.println(PieceUtils.isEmitter(Piece.MIRROR_NW_SE));
    System.out.println(PieceUtils.addLaser(Piece.EMITTER_WEST, false));

    Coordinate c = new Coordinate(5, 3);
    Coordinate out = PieceUtils.move(Piece.MIRROR_NW_SE, c, 0, -1);

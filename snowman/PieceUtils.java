  ...
  public static Piece[][] charsToPieces(char[] description,
      ...
      for (int i = 0; i < ps.length; i++) {
            for (int j = 0; j < ps[0].length; j++) {
                ps[i][j] = charToPiece(description[(width * height) - 1 - j]);
            }
      }
     return ps;
  }
      ...
      if (p == Piece.EMITTER_NORTH) {
         ...
         Coordinate c4 = new Coordinate(c.getX() - 1, c.getY());
          ...
          Coordinate c5 = new Coordinate(c.getX() + xo, c.getY() + yo);
             return c5;
      } else if (p == Piece.MIRROR_SW_NE && xo == -1 && yo == 0) {
             Coordinate c6 = new Coordinate(c.getX() + 1, c.getY() - 1);
             return c6;
      } else if (p == Piece.MIRROR_SW_NE && xo == 1 && yo == 0) {
             Coordinate c7 = new Coordinate(c.getX() - 1, c.getY() + 1);
             return c7;
      } else if (p == Piece.MIRROR_SW_NE && xo == 0 && yo == -1) {
             Coordinate c8 = new Coordinate(c.getX() - 1, c.getY() + 1);
             return c8;
      } else if (p == Piece.MIRROR_SW_NE && xo == 0 && yo == 1) {
             Coordinate c9 = new Coordinate(c.getX() + 1, c.getY() - 1);
             return c9;
      } else if (p == Piece.MIRROR_NW_SE && xo == -1 && yo == 0) {
             Coordinate c10 = new Coordinate(c.getX() + 1, c.getY() + 1);
             return c10;
      } else if (p == Piece.MIRROR_NW_SE && xo == 1 && yo == 0) {
             Coordinate c11 = new Coordinate(c.getX() - 1, c.getY() - 1);
             return c11;
      } else if (p == Piece.MIRROR_NW_SE && xo == 0 && yo == -1) {
             Coordinate c12 = new Coordinate(c.getX() + 1, c.getY() );
             return c12;
      } else if (p == Piece.MIRROR_NW_SE && xo == 0 && yo == 1) {
             Coordinate c13 = new Coordinate(c.getX() - 1, c.getY() - 1);
             return c13;
      } else {
             return c;
      }
